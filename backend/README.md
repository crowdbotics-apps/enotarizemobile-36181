...
## Project Structure
    ...
    ├── enotarizemobile_36181  # Django project configurations
...
1. Clone this repo and `cd enotarizemobile_36181`
...
2. Clone this repo and `cd enotarizemobile_36181`
